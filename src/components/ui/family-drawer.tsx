...
export type FamilyDrawerProps = Omit<ComponentProps<"button">, "onClick" | "children" | "type">;

export default function FamilyDrawer({ className, ...props }: FamilyDrawerProps) {
    ...
    return (
        <>
            <button
                ...
                className={cn("focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 absolute top-1/2 left-1/2 h-[44px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-gray-200 bg-white px-4 py-2 font-medium text-black transition-colors hover:bg-[#F9F9F8] md:font-medium dark:border-none dark:bg-muted dark:shadow-sm dark:text-foreground dark:hover:bg-muted", className)}
                {...props}
                type="button"
            ...
            <Drawer.Root open={isOpen} onOpenChange={setIsOpen}>
                <Drawer.Portal>
                    ...
                    >
                        <motion.div animate={{ height: bounds.height }} transition={reduced ? { duration: 0 } : undefined}>
                            <Drawer.Close asChild>
                                <button
                                    data-vaul-no-drag=""
                                    className="focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 absolute top-7 right-8 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-[#F7F8F9] text-[#949595] transition-transform focus:scale-95 active:scale-75 dark:bg-secondary dark:text-muted-foreground"
                                >
                                    <CloseIcon />
                                </button>
                            </Drawer.Close>
                            <AnimatePresence mode="popLayout">
                                <motion.div
                                    key={view}
                                    transition={{
                                        duration: reduced ? 0 : opacityDuration,
...
export function Button({
    ...
    return (
        <button
            data-vaul-no-drag=""
            className="focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 flex h-12 w-full items-center gap-[15px] rounded-[16px] bg-[#F7F8F9] px-4 text-[17px] font-semibold text-[#222222] transition-transform focus:scale-95 active:scale-95 md:font-medium dark:bg-secondary dark:text-foreground"
            onClick={onClick}
        >
            {children}
        </button>
...
export function SecondaryButton({
    ...
    return (
        <button
            data-vaul-no-drag=""
            className={clsx(
                "focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 flex h-12 w-full items-center justify-center gap-[15px] rounded-full text-center text-[19px] font-semibold transition-transform focus:scale-95 active:scale-95 md:font-medium",
                className,
            )}
            onClick={onClick}
        >
    ...
    return (
        <>
            ...
            <div className="space-y-3">
                ...
                <button
                    className="focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 flex h-12 w-full items-center gap-[15px] rounded-[16px] bg-[#FFF0F0] px-4 text-[17px] font-semibold text-[#FF3F40] transition-transform focus:scale-95 active:scale-95 md:font-medium dark:bg-destructive/15"
                    onClick={() => {
                        setView("remove");
                    }}
                >
