...
const LINKS = [
  { label: "Components", href: "/components", to: "/components", hash: undefined },
  { label: "Sponsors", href: "/#sponsors", to: "/", hash: "sponsors" },
];

const GITHUB_URL = "https://github.com/liaoyio/oooyi-ui";
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-5 z-50">
      ...
      >
        ...
        >
          <img src="/logos/oooyi-ui.svg" alt="" className="h-5 w-5" />
          ooOYi UI
        </Link>
